...
describe('Elements', () => {
    it('should create a new element by its name', () => {
        ...
        expect(elem.exportJSON()).toEqual({active: true, absorption: 1, ascii: ["^", ">", "v", "<"], description: "A one-photon laser source", group: "Emitter", id: 1, link: "./elements/laser", matrix: [], phase: 0, name: "laser", tiles: ""})
    })
