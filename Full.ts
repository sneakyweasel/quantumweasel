...
//         acc[`${dir}-`] = {}
//         acc[`${dir}-`][`${dir}-`] = math.complex(1, 0)
//         // Polarization | gets reflected
//         acc[`${dir}|`] = {}
//         acc[`${dir}|`][`${reflectedDirection}|`] = math.complex(1, 0)
//         return acc
//     }, {}))
// })
...
//     direction.identity,
//     polarization.globalPhase(math.tau / 4)
// )
